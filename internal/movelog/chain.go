...
// move was legal four-in-a-row is the match's question.
...
func (c *Chain) Move(key *forfeit.LogKey, seat uint32, boardIndex, column uint8, height uint32) (*Entry, error) {
	if key == nil {
